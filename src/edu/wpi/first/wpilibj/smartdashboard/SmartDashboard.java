 ...
 * This class is used almost unaltered from the actual WPILib version.
 * The only change is instantiating the table to a dummy one and making it public.
 */
...
public class SmartDashboard {
     ...
     * they came from.
     */
    private static final Hashtable<Sendable, String> tablesToData = new Hashtable<Sendable, String>();
